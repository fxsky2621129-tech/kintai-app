...
(async()=>{
  ...
  try{
    ...
    await page.reload();assert.equal(await page.locator('.law-confirm input').first().isChecked(),true);
    ...
    await context.setOffline(true);await page.reload();assert.equal(await page.locator('.law-card').count(),9);assert.equal(await page.locator('.law-confirm input').first().isChecked(),true);
    ...
    await page.locator('.law-confirm input').nth(1).check();await page.reload();assert.equal(await page.locator('.law-confirm input').nth(1).isChecked(),true);
