const VERSION='kintai-v8-6-6-diagnostic-20260912-1';
const CACHE=`${VERSION}-app`;
const SHELL=['./','./index.html','./style.css?v=8.6.6','./app.js?v=8.6.6','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
