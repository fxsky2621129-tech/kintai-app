const VERSION='kintai-v8-7-0-law-20260919';
const CACHE=`${VERSION}-app`;
const SHELL=['./','./index.html','./style.css?v=8.7.0','./app.js?v=8.7.0','./law-guide.js?v=8.7.0','./manifest.webmanifest','./icon-192.png','./icon-512.png','./localgovjp.json','./gps-check.html','./gps-check.js'];
