const VERSION='kintai-v8-8-0-check-20260919';
const CACHE=`${VERSION}-app`;
const SHELL=['./','./index.html','./style.css?v=8.8.0','./app.js?v=8.8.0','./law-guide.js?v=8.8.0','./quick-check.js?v=8.8.0','./manifest.webmanifest','./icon-192.png','./icon-512.png','./localgovjp.json','./gps-check.html','./gps-check.js'];
...
self.addEventListener('fetch',e=>{
  ...
  e.respondWith((async()=>{
    ...
    const key=(u.pathname===home.pathname||u.pathname===home.pathname+'index.html')?'./index.html':req;
