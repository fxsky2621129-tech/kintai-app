const VERSION='kintai-v8-8-1-layout-cache2-20260926';
const CACHE=`${VERSION}-app`;
const SHELL=['./index.html?v=8.8.1','./style.css?v=8.8.1','./app.js?v=8.8.1','./quick-check.js?v=8.8.1','./law-guide.js?v=8.8.1','./manifest.webmanifest','./icon-192.png','./icon-512.png','./localgovjp.json','./gps-check.html','./gps-check.js'];
...
self.addEventListener('fetch',e=>{
  ...
  e.respondWith((async()=>{
    ...
    const key=(u.pathname===home.pathname||u.pathname===home.pathname+'index.html')?'./index.html?v=8.8.1':req;
